...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: 'hyperscale', name: 'Hyperscale', desc: 'Serve 100,000 requests per second.', icon: '⌬' },
  { id: 'sharded', name: 'Split the Atom', desc: 'A Shard Router splitting writes across 2+ database shards.', icon: '⫛' },
  { id: 'decomposed', name: 'Org Chart Architecture', desc: 'Two products each running through their own dedicated ingress.', icon: '⌘' },
